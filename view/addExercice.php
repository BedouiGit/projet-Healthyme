    ...
    <form action="" method="POST">
        <table border="1" align="center">
            ...
            <tr>
                ...
                <td><input type="text" name="nomEx" id="nomEx" minlength="11" maxlength="50"></td>
            </tr>
            <tr>
                <td>
                    <label for="categorie">categorie:
...
nomExInput.addEventListener('input', function() {
  // Récupérer la valeur actuelle du champ de saisie
  const inputValue = nomExInput.value.trim();
  ...
  if (inputValue.length < minLength || inputValue.length > maxLength) {
    ...
    nomExInput.setCustomValidity(`Le texte doit contenir entre ${minLength} et ${maxLength} caractères.`);
  } else {
    // Réinitialiser le message d'erreur s'il est valide
    nomExInput.setCustomValidity('');
  }
});
