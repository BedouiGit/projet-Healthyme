...
if (
    ...
    if (
        ...
        $ingredientc->addingredient($ingredient);
...
<head>
                ...
                <form action="" method="POST">
                    <table border="1" align="center">
                        ...
                        <tr>
                            ...
                            <td><input type="text" name="idi" id="idi" minlength="0" maxlength="20"></td>
                        </tr>
                        <tr>
                            <td>
                                <label for="nom">nom:
                            ...
                            <td><input type="text" name="nom" id="nom" minlength="3" maxlength="20"></td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td><input type="text" name="descriptioni" id="descriptioni" minlength="9" maxlength="40"></td>
                        </tr>
                        <tr>
                            <td>
                        ...
                        <tr>
                            ...
                            <td><input type="text" name="idr" id="idr" maxlength="20"></td>
                        </tr>
                        <tr align="center">
                            <td>
  ...
  function validateForm() {
    let isValid = true;
    // Validate the input field for id
    const idInput = document.querySelector('#idi');
    if (idInput.value.length > 20) {
      showError(idInput, 'Id must be less than 20 characters');
      isValid = false;
    }
    // Validate the input field for nom
    const nomInput = document.querySelector('#nom');
    if (nomInput.value.length < 3 || nomInput.value.length > 20) {
      showError(nomInput, 'Nom must be between 3 and 20 characters');
      isValid = false;
    }
    // Validate the input field for description
    const descriptionInput = document.querySelector('#descriptioni');
    if (descriptionInput.value.length < 9 || descriptionInput.value.length > 40) {
      showError(descriptionInput, 'Description must be between 9 and 40 characters');
      isValid = false;
    }
    // Validate the input field for categorie
    const categorieInput = document.querySelector('#categoriei');
    if (!categorieInput.value){
showError(categorieInput, 'Categorie is required');
isValid = false;
}
// Validate the input field for prix
const prixInput = document.querySelector('#prix');
if (isNaN(prixInput.value) || prixInput.value <= 0) {
showError(prixInput, 'Prix must be a positive number');
isValid = false;
}
// Validate the input field for idr
const idrInput = document.querySelector('#idr');
if (idrInput.value.length > 20) {
showError(idrInput, 'Id recette must be less than 20 characters');
isValid = false;
}
return isValid;
}
    ...
    <form action="" method="POST">
        <table border="1" align="center">
            ...
            <tr>
                ...
                <td><input type="text" name="descriptionr" id="descriptionr" maxlength="20"></td>
            </tr>
            <tr>
                <td>
