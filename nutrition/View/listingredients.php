            ...
            <tr>
                ...
                <td align="center">
                    <form method="POST" action="updateingredient.php">
                        ...
                        <input type="hidden" value=<?PHP echo $ingredient['idi']; ?> name="idi">
                    </form>
                </td>
                <td>
                    <a href="deleteingredient.php?idi=<?php echo $ingredient['idi']; ?>">Delete</a>
                </td>
            </tr>
        <?php
        }
...
<div class"recette">
    <center>
        ...
        <h2>
            <a href="addrecette.php">Add recette</a>
        </h2>
    </center>
    <table border="1" align="center" width="70%">
        <tr>
            ...
            <tr>
                ...
                <td align="center">
                    <form method="POST" action="updaterecette.php">
                        <input type="submit" name="update" value="Update">
                        <input type="hidden" value=<?PHP echo $recette['idr']; ?> name="idr">
                    </form>
                </td>
                <td>
                    <a href="deleterecette.php?idr=<?php echo $recette['idr']; ?>">Delete</a>
                </td>
            </tr>
        <?php
        }
